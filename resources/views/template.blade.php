	...
	<body>
		<div class="container-fluid" id="content">
			...
			<div class="row padding">
				<div class="col-md-6 col-md-offset-3">
					<div class="row">
						<a title="Twitter" class="fa fa-3x fa-twitter col-md-offset-3 col-md-2" href="https://twitter.com/sirrohara" target="_blank"></a>
						<a title="LinkedIn" class="fa fa-3x fa-linkedin col-md-2" href="https://www.linkedin.com/pub/ryan-w-o-hara/4b/ab9/824" target="_blank"></a>
						<a title="GitHub" class="fa fa-3x fa-github col-md-2" href="https://github.com/ryanwohara" target="_blank"></a>
					</div>
				</div>
			</div>
			<div class="row">
